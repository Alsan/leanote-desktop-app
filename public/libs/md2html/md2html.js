	...
	return (function processATXStyleHeaders()  {
		...
		*/
		...
		return text.replace(/^(\#{1,6})[ \t]*(.+?)[ \t]*\#*\n+/gm, function (wholeMatch, m1, m2) {
			var level = m1.length;
			var levelCode = processLevel(level);
